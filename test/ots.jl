...
@testset "test ac ots" begin
    ...
    @testset "5-bus case" begin
        result = run_ots("../test/data/matpower/case5.m", ACPPowerModel, minlp_solver)
    ...
    @testset "5-bus with negative branch reactance case" begin
        result = run_ots("../test/data/matpower/case5_ext.m", ACPPowerModel, minlp_solver)
    ...
    @testset "5-bus with asymmetric line charge" begin
        result = run_ots("../test/data/pti/case5_alc.raw", ACPPowerModel, minlp_solver)
    ...
    #    result = run_ots("../test/data/matpower/case6.m", ACPPowerModel, minlp_solver)
...
@testset "test dc ots" begin
    ...
    @testset "5-bus case" begin
        result = run_ots("../test/data/matpower/case5.m", DCPPowerModel, minlp_solver)
    ...
    @testset "5-bus case, MIP solver" begin
        result = run_ots("../test/data/matpower/case5.m", DCPPowerModel, milp_solver)
    ...
    @testset "5-bus with negative branch reactance case" begin
        result = run_ots("../test/data/matpower/case5_ext.m", DCPPowerModel, minlp_solver)
    ...
    @testset "6-bus case" begin
        result = run_ots("../test/data/matpower/case6.m", DCPPowerModel, minlp_solver)
...
@testset "test dc+ll ots" begin
    ...
    @testset "5-bus case" begin
        result = run_ots("../test/data/matpower/case5.m", DCPLLPowerModel, minlp_solver)
    ...
    @testset "5-bus with negative branch reactance case" begin
        result = run_ots("../test/data/matpower/case5_ext.m", DCPLLPowerModel, minlp_solver)
    ...
    @testset "6-bus case" begin
        result = run_ots("../test/data/matpower/case6.m", DCPLLPowerModel, minlp_solver)
...
@testset "test soc ots" begin
    @testset "3-bus case" begin
        result = run_ots("../test/data/matpower/case3.m", SOCWRPowerModel, minlp_solver)
    ...
    @testset "5-bus case" begin
        result = run_ots("../test/data/matpower/case5.m", SOCWRPowerModel, minlp_solver)
    ...
    @testset "5-bus with negative branch reactance case" begin
        result = run_ots("../test/data/matpower/case5_ext.m", SOCWRPowerModel, minlp_solver)
    ...
    @testset "5-bus with asymmetric line charge" begin
        result = run_ots("../test/data/pti/case5_alc.raw", SOCWRPowerModel, minlp_solver)
    ...
    @testset "6-bus case" begin
        result = run_ots("../test/data/matpower/case6.m", SOCWRPowerModel, minlp_solver)
...
@testset "test qc ots" begin
    @testset "3-bus case" begin
        result = run_ots("../test/data/matpower/case3.m", QCRMPowerModel, minlp_solver)
    ...
    @testset "5-bus case" begin
        result = run_ots("../test/data/matpower/case5.m", QCRMPowerModel, minlp_solver)
    ...
    @testset "5-bus with negative branch reactance case" begin
        result = run_ots("../test/data/matpower/case5_ext.m", QCRMPowerModel, minlp_solver)
    ...
    @testset "5-bus asymmetric case" begin
        result = run_ots("../test/data/matpower/case5_asym.m", QCRMPowerModel, minlp_solver)
    ...
    @testset "5-bus with asymmetric line charge" begin
        result = run_ots("../test/data/pti/case5_alc.raw", QCRMPowerModel, minlp_solver)
    ...
    @testset "6-bus case" begin
        result = run_ots("../test/data/matpower/case6.m", QCRMPowerModel, minlp_solver)
...
@testset "test lpac ots" begin
    @testset "3-bus case" begin
        result = run_ots("../test/data/matpower/case3.m", LPACCPowerModel, minlp_solver)
    ...
    @testset "5-bus case" begin
        result = run_ots("../test/data/matpower/case5.m", LPACCPowerModel, minlp_solver)
    ...
    @testset "5-bus with negative branch reactance case" begin
        result = run_ots("../test/data/matpower/case5_ext.m", LPACCPowerModel, minlp_solver)
    ...
    @testset "5-bus asymmetric case" begin
        result = run_ots("../test/data/matpower/case5_asym.m", LPACCPowerModel, minlp_solver)
    ...
    @testset "5-bus with asymmetric line charge" begin
        result = run_ots("../test/data/pti/case5_alc.raw", LPACCPowerModel, minlp_solver)
    ...
    @testset "6-bus case" begin
        result = run_ots("../test/data/matpower/case6.m", LPACCPowerModel, minlp_solver)
