...
"""
function variable_gen_power_imaginary(
        pm::AbstractActivePowerModel; nw::Int = nw_id_default,
...
apo models ignore reactive power flows
"""
function variable_storage_power_imaginary(
        pm::AbstractActivePowerModel; nw::Int = nw_id_default,
        report::Bool = true, kwargs...)
...
apo models ignore reactive power flows
"""
function variable_branch_power_imaginary(
        pm::AbstractActivePowerModel; nw::Int = nw_id_default,
        report::Bool = true, kwargs...)
...
apo models ignore reactive power flows
"""
function variable_dcline_power_imaginary(
        pm::AbstractActivePowerModel; nw::Int = nw_id_default,
        report::Bool = true, kwargs...)
...
"""
function constraint_gen_power_on_off(
        pm::AbstractActivePowerModel, n::Int, i::Int, pmin, pmax, qmin, qmax)
    pg = var(pm, n, :pg, i)
    z = var(pm, n, :z_gen, i)
...
function constraint_power_balance(
        pm::AbstractActivePowerModel, n::Int, i::Int, bus_arcs, bus_arcs_dc,
...
function constraint_ne_power_balance(
        pm::AbstractDCPModel, n::Int, i, bus_arcs, bus_arcs_dc, bus_arcs_sw,
...
"""
"""
function expression_bus_power_injection(pm::AbstractActivePowerModel, n::Int, i::Int,
...
"""
"""
function constraint_thermal_limit_from_on_off(
        pm::AbstractActivePowerModel, n::Int, i, f_idx, rate_a)
    p_fr = var(pm, n, :p, f_idx)
...
function constraint_thermal_limit_to_on_off(
        pm::AbstractActivePowerModel, n::Int, i, t_idx, rate_a)
    p_to = var(pm, n, :p, t_idx)
    z = var(pm, n, :z_branch, i)
...
"""
"""
function constraint_ne_thermal_limit_from(
        pm::AbstractActivePowerModel, n::Int, i, f_idx, rate_a)
...
"""
"""
function constraint_storage_current_limit(
        pm::AbstractActivePowerModel, n::Int, i, bus, rating)
    ps = var(pm, n, :ps, i)
...
"""
"""
function constraint_storage_losses(pm::AbstractActivePowerModel, n::Int, i,
...
function constraint_storage_on_off(pm::AbstractActivePowerModel, n::Int, i, pmin,
